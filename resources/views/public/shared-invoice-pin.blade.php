...
<body>
  <div class="card">
    <h1>Protected Invoice</h1>
    <p>Please enter the PIN sent by the provider to view this shared invoice.</p>
    <form method="POST" action="{{ route('public.shared-invoices.authenticate', ['token' => $token]) }}">
      @csrf
