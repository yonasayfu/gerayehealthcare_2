        ...
        <div class="liquidGlass-content flex items-center justify-between p-4 gap-4">
          <div class="flex items-center gap-4">
            <div class="print:hidden">
              <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Marketing Leads</h1>
              <p class="text-sm text-gray-600 dark:text-gray-300">Manage marketing leads</p>
            </div>
          ...
          <div class="flex items-center gap-2 print:hidden">
            <Link :href="route('admin.marketing-leads.create')" class="btn-glass">
              <span>Add Marketing Lead</span>
            </Link>
