      ...
      <div class="liquidGlass-wrapper print:hidden w-full rounded-t-lg">
        ...
        <div class="liquidGlass-content flex items-center justify-between p-6">
          <div class="print:hidden">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Marketing Lead Details</h3>
            <p class="text-sm text-gray-600 dark:text-gray-300">Marketing Lead: {{ marketingLead.first_name }} {{ marketingLead.last_name }}</p>
          </div>
