...
const breadcrumbs = [
  ...
  { title: `Edit #${props.prescription?.id ?? ''}`, href: null },
]
...
function submit() {
  form.transform((data: any) => ({ ...data, _method: 'PUT' }))
      .post(route('admin.prescriptions.update', props.prescription.id))
}
</script>
      ...
      <div class="liquidGlass-wrapper">
        ...
        <div class="liquidGlass-content p-4">
          <div class="flex items-center justify-between mb-4">
            <div>
              <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Edit Prescription</h1>
              <p class="text-sm text-gray-600 dark:text-gray-300">Update details and items</p>
            </div>
          ...
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div>
              ...
              <div class="space-y-3">
                <div v-for="(item, idx) in form.items" :key="item.id ?? idx" class="rounded-md border border-gray-200 dark:border-gray-700 p-3 bg-white/60 dark:bg-gray-900/60">
