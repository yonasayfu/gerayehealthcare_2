  ...
  <AppLayout :breadcrumbs="breadcrumbs">
      ...
      <div class="liquidGlass-wrapper print:hidden w-full rounded-t-lg">
        ...
        <div class="liquidGlass-content flex items-center justify-between p-6">
          <div class="print:hidden">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Inventory Transaction Details</h3>
            <p class="text-sm text-gray-600 dark:text-gray-300">Inventory Transaction: {{ item.name || item.title || item.id }}</p>
          </div>
      ...
      <div class="p-6 border-t border-gray-200 dark:border-gray-700 rounded-b print:hidden">
        <div class="flex justify-end gap-2">
          <Link :href="route('admin.inventory-transactions.index')" class="btn-glass btn-glass-sm">Back to List</Link>
          <button @click="printSingleInventoryTransaction" class="btn-glass btn-glass-sm">Print Current</button>
          <Link :href="route('admin.inventory-transactions.edit', item.id)" class="btn-glass btn-glass-sm">Edit</Link>
        </div>
      </div>
