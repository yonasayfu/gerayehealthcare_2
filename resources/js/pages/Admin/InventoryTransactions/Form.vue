      ...
      <div class="border-b border-gray-900/10 pb-6">
        ...
        <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="sm:col-span-3">
            ...
            <input type="number" id="quantity" v-model="form.quantity" class="shadow-sm border border-gray-300 text-gray-900 dark:text-white sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 bg-white dark:bg-gray-800" required min="1" />
          ...
          <div class="sm:col-span-3">
            ...
            <select id="performed_by_id" v-model="form.performed_by_id" class="shadow-sm border border-gray-300 text-gray-900 dark:text-white sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 bg-white dark:bg-gray-800" required>
