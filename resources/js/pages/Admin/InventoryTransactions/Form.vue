      ...
      <div class="border-b border-gray-900/10 pb-6">
        ...
        <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="sm:col-span-3">
            ...
            <select id="transaction_type" v-model="form.transaction_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" required>
          ...
          <div class="sm:col-span-3">
            ...
            <input type="number" id="quantity" v-model="form.quantity" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" required min="1" />
          ...
          <div class="sm:col-span-3">
            ...
            <select id="performed_by_id" v-model="form.performed_by_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" required>
          ...
          <div class="sm:col-span-3">
            ...
            <input type="text" id="from_location" v-model="form.from_location" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" />
          ...
          <div class="sm:col-span-3">
            ...
            <input type="text" id="to_location" v-model="form.to_location" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" />
