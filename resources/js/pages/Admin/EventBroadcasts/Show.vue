...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
      ...
      <ShowHeader title="Event Broadcast Details" :subtitle="`Event Broadcast: ${eventBroadcast.channel || eventBroadcast.id}`">
        <template #actions>
          <Link :href="route('admin.event-broadcasts.index')" class="btn-glass btn-glass-sm">Back</Link>
        </template>
      </ShowHeader>
