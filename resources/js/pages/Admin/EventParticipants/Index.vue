...
function exportData(type) {
    window.open(route('admin.event-participants.export', { type }), '_blank');
}
...
const printAllParticipants = () => {
    window.open(route('admin.event-participants.export', { type: 'pdf' }), '_blank');
};
    ...
    <AdminLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6 p-6 print:p-0 print:space-y-0">
            <div class="rounded-lg bg-muted/40 p-4 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-4 print:hidden">
                <div>
                    <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Event Participants</h1>
                    <p class="text-sm text-muted-foreground">Manage all event participants here.</p>
                </div>
                <div class="flex flex-wrap gap-2">
                    <Link :href="route('admin.event-participants.create')" class="inline-flex items-center gap-2 bg-cyan-600 hover:bg-cyan-700 text-white text-sm px-4 py-2 rounded-md transition">
                        + Add Participant
                    </Link>
                    ...
                    <button @click="printAllParticipants" class="inline-flex items-center gap-1 text-sm px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-200">
                        ...
                        <tr v-for="participant in participants.data" :key="participant.id" class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 print-table-row">
                            ...
                            <td class="px-6 py-4 text-right print:hidden">
                                <div class="inline-flex items-center justify-end space-x-2">
                                    ...
                                    <button @click="destroy(participant.id)" class="text-red-600 hover:text-red-800 inline-flex items-center justify-center w-8 h-8 rounded-full hover:bg-red-100 dark:hover:bg-red-900" title="Delete">
