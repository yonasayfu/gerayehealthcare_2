  ...
  <form @submit.prevent="emit('submit')">
    <div class="space-y-6">
      ...
      <div class="border-b border-gray-900/10 pb-6">
        ...
        <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            ...
            <input type="text" id="name" v-model="form.name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" required />
            <div v-if="form.errors.name" class="text-red-500 text-sm mt-1">{{ form.errors.name }}</div>
          </div>

          <div class="sm:col-span-3">
            <label for="serial_number" class="block text-sm font-medium text-gray-900 dark:text-white">Serial Number</label>
            <input type="text" id="serial_number" v-model="form.serial_number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" />
          ...
          <div class="sm:col-span-3">
            ...
            <select id="item_category" v-model="form.item_category" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800">
          ...
          <div class="sm:col-span-3">
            ...
            <select id="item_type" v-model="form.item_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" :disabled="!form.item_category">
      ...
      <div class="border-b border-gray-900/10 pb-6">
        ...
        <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            ...
            <input type="date" id="purchase_date" v-model="form.purchase_date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" />
          ...
          <div class="sm:col-span-3">
            ...
            <input type="date" id="warranty_expiry" v-model="form.warranty_expiry" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" />
          ...
          <div class="sm:col-span-3">
            ...
            <select id="supplier_id" v-model="form.supplier_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800">
          ...
          <div class="sm:col-span-3">
            ...
            <select id="assigned_to_type" v-model="form.assigned_to_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800">
          ...
          <div class="sm:col-span-3" v-if="form.assigned_to_type">
            ...
            <select id="assigned_to_id" v-model="form.assigned_to_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800">
      ...
      <div class="border-b border-gray-900/10 pb-6">
        ...
        <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            ...
            <input type="date" id="last_maintenance_date" v-model="form.last_maintenance_date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" />
          ...
          <div class="sm:col-span-3">
            ...
            <input type="date" id="next_maintenance_due" v-model="form.next_maintenance_due" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" />
          ...
          <div class="col-span-full">
            ...
            <textarea id="maintenance_schedule" v-model="form.maintenance_schedule" rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800"></textarea>
      ...
      <div>
        ...
        <div class="mt-4">
          <textarea id="notes" v-model="form.notes" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800"></textarea>
