  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-6 space-y-6">
      <div class="rounded-lg bg-muted/40 p-4 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-4 print:hidden">
        <div>
          <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Inventory Request Details: #{{ inventoryRequest.id }}</h1>
          <p class="text-sm text-muted-foreground">Comprehensive view of inventory request record.</p>
        </div>
