...
<template>
  <Head title="Print Marketing Budgets" />

  <div class="print-container">
    <div class="print-header-content">
      <img src="/images/geraye_logo.jpeg" alt="Geraye Logo" class="print-logo">
      <h1 class="print-clinic-name">Geraye Home Care Services</h1>
      <p class="print-document-title">Marketing Budgets List (Current View)</p>
      ...
      <table class="print-table">
        ...
        <tbody>
          ...
          <tr v-if="marketingBudgets.length === 0">
            <td colspan="8" class="text-center">No marketing budgets found for the current view.</td>
          </tr>
        </tbody>
      </table>
    </div>
