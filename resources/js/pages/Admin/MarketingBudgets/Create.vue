...
<template>
  <Head title="Create Marketing Budget" />

  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="space-y-6 p-6">
      <div class="rounded-lg bg-muted/40 p-4 shadow-sm">
        <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Create Marketing Budget</h1>
        <p class="text-sm text-muted-foreground">Fill in the details to create a new marketing budget.</p>
      </div>
