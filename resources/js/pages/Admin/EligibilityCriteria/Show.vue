    ...
    <div class="bg-white border border-4 rounded-lg shadow relative m-10">
        ...
        <div class="flex items-start justify-between p-5 border-b rounded-t">
            <h3 class="text-xl font-semibold">
                Eligibility Criteria Details: {{ eligibilityCriteria.criteria_title }}
            </h3>
            <Link :href="route('admin.eligibility-criteria.index')" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center print:hidden">
        ...
        <div class="p-6 space-y-6">
            <div class="bg-white dark:bg-gray-900 shadow rounded-lg p-8 space-y-8 print:shadow-none print:rounded-none print:p-0 print:m-0 print:w-auto print:h-auto print:flex-shrink-0">
                ...
                <div class="hidden print:block text-center mb-4 print:mb-2 print-header-content">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 print-document-title">Eligibility Criteria Document</p>
                    <hr class="my-3 border-gray-300 print:my-2">
                </div>

                <div class="border-b pb-4 mb-4 print:pb-2 print:mb-2">
                  <h2 class="text-lg font-semibold text-gray-800 dark:text-white mb-4 print:mb-2">Criteria Information</h2>
                  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-3 gap-x-6 print:gap-y-2 print:gap-x-4">
                    ...
                    <div>
                      ...
                      <p class="font-medium text-gray-900 dark:text-white">{{ eligibilityCriteria.operator }}</p>
                    </div>
                    <div>
                      <p class="text-sm text-muted-foreground">Value:</p>
                      <p class="font-medium text-gray-900 dark:text-white">{{ eligibilityCriteria.value }}</p>
                    </div>
                  </div>
                </div>
        ...
        <div class="p-6 border-t border-gray-200 rounded-b print:hidden">
            <div class="flex flex-wrap gap-2">
              ...
              <Link
                :href="route('admin.eligibility-criteria.index')"
