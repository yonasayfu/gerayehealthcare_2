...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
      ...
      <ShowHeader title="Event Staff Assignment Details" :subtitle="`Event Staff Assignment: ${assignment.role || assignment.id}`">
        <template #actions>
          <Link :href="route('admin.event-staff-assignments.index')" class="btn-glass btn-glass-sm">Back</Link>
        </template>
      </ShowHeader>
