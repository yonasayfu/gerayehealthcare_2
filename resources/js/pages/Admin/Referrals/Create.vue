...
<template>
  <Head title="Create New Referral" />
      ...
      <div class="liquidGlass-wrapper print:hidden w-full rounded-t-lg">
        ...
        <div class="liquidGlass-content flex items-center justify-between p-6">
          <div class="print:hidden">
            <h1 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Create New Referral</h1>
            <p class="text-sm text-gray-600 dark:text-gray-300 mt-1">Fill required information to create a referral.</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-sm p-6">
        <form @submit.prevent="submit" class="space-y-4">
          ...
          <div class="flex justify-end gap-2 pt-2">
            <Link :href="route('admin.referrals.index')" class="btn-glass btn-glass-sm">Cancel</Link>
            ...
            >
              {{ form.processing ? 'Creating...' : 'Create Referral' }}
            </button>
          </div>
        </form>
      </div>
