  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="space-y-6 p-6">
      <div class="rounded-lg bg-muted/40 p-4 shadow-sm">
        <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Create Marketing Task</h1>
        <p class="text-sm text-muted-foreground">Fill in the details to create a new marketing task.</p>
      </div>
