        ...
        <div class="liquidGlass-content flex items-center justify-between p-4 gap-4">
          <div class="flex items-center gap-4">
            <div class="print:hidden">
              <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Partner Commissions</h1>
              <p class="text-sm text-gray-600 dark:text-gray-300">Manage partner commissions</p>
            </div>
      ...
      <div class="flex flex-col md:flex-row justify-between items-center gap-4 print:hidden">
        ...
        <div class="search-glass relative w-full md:w-1/3">
          <input
            v-model="search"
            type="text"
            placeholder="Search partner commissions..."
            ...
            <tr v-for="(commission, i) in partnerCommissions.data" :key="commission.id" class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 print-table-row">
              ...
              <td class="px-6 py-4 text-right print:hidden">
                <div class="inline-flex items-center justify-end space-x-2">
                  <Link
                    :href="route('admin.partner-commissions.show', commission.id)"
                  ...
                  <Link
                    :href="route('admin.partner-commissions.edit', commission.id)"
...
@media print {
  ...
  .print-footer { position: fixed; bottom: 0; left: 0; right: 0; background: #fff; padding-bottom: 8px; }
}
</style>
