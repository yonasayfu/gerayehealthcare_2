...
const tasks = computed(() => {
  return Array.isArray(props.taskDelegations) ? props.taskDelegations : [props.taskDelegations];
});
...
<template>
  <Head title="Print All Task Delegations" />
  ...
  <div class="print-document">
    ...
    <div v-else-if="tasks.length === 0" class="no-data-message">
      <p>No task delegations found to print.</p>
    </div>

    <div v-else>
      <div class="print-header">
        <img src="/images/geraye_logo.jpeg" alt="Geraye Healthcare Logo" style="max-width: 150px; margin-bottom: 10px;">
        <h1>All Task Delegations</h1>
