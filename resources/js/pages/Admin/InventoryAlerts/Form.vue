      ...
      <div class="border-b border-gray-900/10 pb-6">
        ...
        <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            ...
            <select id="item_id" v-model="form.item_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800">
          ...
          <div class="sm:col-span-3">
            ...
            <select id="alert_type" v-model="form.alert_type" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" required>
          ...
          <div class="col-span-full">
            ...
            <textarea id="message" v-model="form.message" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" required></textarea>
          ...
          <div class="sm:col-span-3">
            ...
            <input type="text" id="threshold_value" v-model="form.threshold_value" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:bg-gray-800" placeholder="e.g., 5 (for low stock), 2025-12-31 (for expiry)" />
