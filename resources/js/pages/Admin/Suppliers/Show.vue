      ...
      <div class="liquidGlass-wrapper print:hidden w-full rounded-t-lg">
        ...
        <div class="liquidGlass-content flex items-center justify-between p-6">
          <div class="print:hidden">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Supplier Details</h3>
            <p class="text-sm text-gray-600 dark:text-gray-300">Supplier: {{ supplier.name }}</p>
          </div>
