...
const form = useForm({
  ...
  form_fields: JSON.stringify(props.landingPage.form_fields, null, 2),
...
<template>
  <Head :title="`Edit ${landingPage.page_title}`" />

  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="space-y-6 p-6">
      <div class="rounded-lg bg-muted/40 p-4 shadow-sm">
        <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Edit Landing Page</h1>
        <p class="text-sm text-muted-foreground">Update the details of the landing page.</p>
      </div>
