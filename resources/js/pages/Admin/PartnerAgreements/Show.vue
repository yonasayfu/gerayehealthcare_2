    ...
    <div class="bg-white border border-4 rounded-lg shadow relative m-10">
        ...
        <div class="flex items-center justify-between p-5 border-b rounded-t">
            <h3 class="text-xl font-semibold">
                Partner Agreement Details: {{ partnerAgreement.agreement_title }}
            </h3>
            <div class="flex items-center gap-3">
              <Link :href="route('admin.partner-agreements.index')" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex items-center print:hidden" title="Close">
        ...
        <div class="p-6 border-t border-gray-200 rounded-b">
            <div class="flex flex-wrap gap-2">
              <Link :href="route('admin.partner-agreements.index')" class="btn btn-outline print:hidden">
                Back to List
              </Link>
              <button @click="printPage" class="btn btn-dark print:hidden">
                <Printer class="h-4 w-4" /> Print Current
              </button>
              <Link :href="route('admin.partner-agreements.edit', props.partnerAgreement.id)"
                class="btn btn-primary print:hidden">
                <Edit3 class="w-4 h-4" /> Edit Agreement
              </Link>
            </div>
        </div>
