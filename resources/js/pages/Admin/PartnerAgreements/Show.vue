...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow relative m-10">
      <ShowHeader title="Partner Agreement Details" :subtitle="`Partner Agreement: ${partnerAgreement.agreement_title}`">
        <template #actions>
          <Link :href="route('admin.partner-agreements.index')" class="btn-glass btn-glass-sm">Back</Link>
        </template>
      </ShowHeader>
