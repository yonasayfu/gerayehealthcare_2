  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="bg-white border border-4 rounded-lg shadow relative m-10">
        ...
        <div class="p-6 border-t border-gray-200 rounded-b">
            <Link :href="route('admin.visit-services.edit', visitService.id)" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
              Edit Visit
            </Link>
        </div>
