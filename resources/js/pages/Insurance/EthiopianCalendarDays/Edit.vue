...
const form = useForm({
    gregorian_date: props.ethiopianCalendarDay.gregorian_date,
    ethiopian_date: props.ethiopianCalendarDay.ethiopian_date,
    description: props.ethiopianCalendarDay.description,
    is_holiday: props.ethiopianCalendarDay.is_holiday,
    region: props.ethiopianCalendarDay.region,
});
