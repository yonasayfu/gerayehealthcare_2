    ...
    <div class="space-y-6 p-6">
      ...
      <div class="liquidGlass-wrapper relative overflow-hidden rounded-xl p-5">
        ...
        <div class="relative flex items-center justify-between">
          <div>
            <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Edit Insurance Policy</h1>
            <p class="text-sm text-muted-foreground">Update details and save changes.</p>
          </div>
...
const breadcrumbs = [
  ...
  { title: 'Edit', href: route('admin.insurance-policies.index') },
]
