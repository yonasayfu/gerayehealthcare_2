...
class Container_c2f54a83eb extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_c2f54a83eb $container)
			{
	...
	public function createServiceContainer(): Container_c2f54a83eb
	{
		return $this;
	}
