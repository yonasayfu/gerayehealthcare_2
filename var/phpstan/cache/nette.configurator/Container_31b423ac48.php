...
class Container_31b423ac48 extends _PHPStan_2d0955352\Nette\DI\Container
{
    protected $tags = [
    ...
    public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
    {
        return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
            ...
            [
                ...
                '#extends unknown class .+BaseApiController#',
    ...
    public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
    {
        return new class($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
        {
            ...
            public function __construct(Container_31b423ac48 $container)
            {
    ...
    public function createService082(): PHPStan\File\FileExcluderFactory
    {
        return new PHPStan\File\FileExcluderFactory(
            $this->getService('083'),
            [],
            ['analyseAndScan' => ['/Users/yonassayfu/VSProject/gerayehealthcare/tests/*'], 'analyse' => []]
        );
    }
    ...
    public function createServiceContainer(): Container_31b423ac48
    {
        return $this;
    }
    ...
    protected function getStaticParameters(): array
    {
        return [
            ...
            'excludes_analyse' => [],
            'excludePaths' => ['analyseAndScan' => ['/Users/yonassayfu/VSProject/gerayehealthcare/tests/*'], 'analyse' => []],
            'level' => 1,
