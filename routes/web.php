...
Route::middleware(['auth', 'verified', 'deny_roles:guest,patient'])
    ...
    ->group(function () {
        ...
        Route::post('daily-tasks/update', [DailyTaskTrackingController::class, 'updateTask'])->name('daily-tasks.update');

        // KPI Dashboard (accessible to supervisors)
        Route::get('kpi-dashboard', [DailyTaskTrackingController::class, 'kpiDashboard'])->name('kpi-dashboard');
    });
