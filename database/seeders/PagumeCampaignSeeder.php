...
class PagumeCampaignSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        EventRecommendation::factory()->count(5)->create(['event_id' => $event->id]);
        EligibilityCriteria::factory()->count(5)->create(['event_id' => $event->id]);
        EventStaffAssignment::factory()->count(5)->create(['event_id' => $event->id]);
    }
}
