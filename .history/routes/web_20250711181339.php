...
Route::middleware(['auth', 'verified', 'role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value])
    ...
    ->group(function () {
        ...
        // --- Admin Leave Request Routes (using resource for consistency and unique URI) ---
        Route::resource('admin-leave-requests', AdminLeaveRequestController::class)->only(['index', 'update']);
