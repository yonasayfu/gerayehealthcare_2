...
use App\Http\Controllers\Staff\LeaveRequestController; StaffLeaveRequestController;
...
Route::middleware(['auth', 'verified', 'role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value])
    ...
    ->group(function () {
        ...
        // --- DEBUGGING: Simplified Route Names for Admins ---
        Route::get('leave-requests', [AdminLeaveRequestController::class, 'index'])->name('leave_requests_index');
        Route::put('leave-requests/{leave_request}', [AdminLeaveRequestController::class, 'update'])->name('leave_requests_update');
...
Route::middleware(['auth', 'verified', 'role:' . RoleEnum::STAFF->value])
    ...
    ->group(function () {
        ...
        // --- DEBUGGING: Simplified Route Names for Staff ---
        Route::get('leave-requests', [LeaveRequestController::class, 'index'])->name('leave_requests_index');
        Route::post('leave-requests', [LeaveRequestController::class, 'store'])->name('leave_requests_store');
    });
