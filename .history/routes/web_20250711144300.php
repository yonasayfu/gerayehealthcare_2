...
Route::get('dashboard', function () {
    ...
    if (Auth::user()->hasAnyRole([RoleEnum::SUPER_ADMIN->value, RoleEnum::ADMIN->value])) {
        // If they are, execute the index method from our new Admin/DashboardController
        return app(DashboardController::class)->index();
    }
    // For any other role (i.e., Staff), render the generic dashboard page
