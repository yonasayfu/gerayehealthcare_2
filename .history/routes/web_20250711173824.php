...
Route::middleware(['auth', 'verified', 'role:' . RoleEnum::STAFF->value])
    ...
    ->group(function () {
        ...
        Route::get('leave-requests', [StaffLeaveRequestController::class, 'index'])->name('leave_requests_index');
        Route::post('leave-requests', [StaffLeaveRequestController::class, 'store'])->name('leave_requests_store');
    });
