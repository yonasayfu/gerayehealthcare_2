...
Route::middleware(['auth', 'verified', 'role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value])
    ...
    ->group(function () {
        ...
        // --- NEW: Manually Defined Leave Request Routes for Admins ---
...
Route::middleware(['auth', 'verified', 'role:' . RoleEnum::STAFF->value])
    ...
    ->group(function () {
        ...
        // --- NEW: Manually Defined Leave Request Routes for Staff ---
        Route::get('leave-requests', [StaffLeaveRequestController::class, 'index'])->name('leave-requests.index');
        Route::post('leave-requests', [StaffLeaveRequestController::class, 'store'])->name('leave-requests.store');
    });
