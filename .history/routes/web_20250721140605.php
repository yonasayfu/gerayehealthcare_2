...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/chapa/initiate', [App\Http\Controllers\ChapaPaymentController::class, 'initiatePayment'])
        ->name('chapa.initiate');
    Route::get('/chapa/verify/{tx_ref}', [App\Http\Controllers\ChapaPaymentController::class, 'verifyPayment'])
        ->name('chapa.verify');
    Route::post('/chapa/webhook', [App\Http\Controllers\ChapaPaymentController::class, 'handleWebhook'])
        ->name('chapa.webhook');
});
...
Route::middleware(['auth', 'verified', 'role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value])
    ...
    ->group(function () {
        ...
        // Invoices
        Route::resource('invoices', InvoiceController::class); // Removed ->except(['edit', 'update', 'destroy'])
