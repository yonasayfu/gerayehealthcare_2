...
Route::middleware(['auth', 'verified', 'role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value])
    ...
    ->group(function () {
        ...
        Route::get('events/print-all', [App\Http\Controllers\EventController::class, 'printAll'])->name('events.printAll');
        Route::get('events/print-current', [App\Http\Controllers\EventController::class, 'printCurrent'])->name('events.printCurrent');
        Route::get('events/{event}/print', [App\Http\Controllers\EventController::class, 'printSingle'])->name('events.print');
        Route::resource('events', App\Http\Controllers\EventController::class);

        // Eligibility Criteria
        Route::resource('eligibility-criteria', App\Http\Controllers\EligibilityCriteriaController::class);

        // Event Recommendations
        Route::resource('event-recommendations', App\Http\Controllers\EventRecommendationController::class);
        Route::get('eligibility-criteria/export', [App\Http\Controllers\EligibilityCriteriaController::class, 'export'])->name('eligibility-criteria.export');
        Route::get('eligibility-criteria/print-all', [App\Http\Controllers\EligibilityCriteriaController::class, 'printAll'])->name('eligibility-criteria.printAll');
        Route::get('eligibility-criteria/print-current', [App\Http\Controllers\EligibilityCriteriaController::class, 'printCurrent'])->name('eligibility-criteria.printCurrent');
        Route::get('eligibility-criteria/{eligibility_criterion}/print', [App\Http\Controllers\EligibilityCriteriaController::class, 'printSingle'])->name('eligibility-criteria.print');

        Route::get('event-recommendations/export', [App\Http\Controllers\EventRecommendationController::class, 'export'])->name('event-recommendations.export');
        Route::get('event-recommendations/print-all', [App\Http\Controllers\EventRecommendationController::class, 'printAll'])->name('event-recommendations.printAll');
        Route::get('event-recommendations/print-current', [App\Http\Controllers\EventRecommendationController::class, 'printCurrent'])->name('event-recommendations.printCurrent');
        Route::get('event-recommendations/{event_recommendation}/print', [App\Http\Controllers\EventRecommendationController::class, 'printSingle'])->name('event-recommendations.print');

        // Event Participants
        Route::resource('event-participants', App\Http\Controllers\EventParticipantController::class);
        Route::get('event-participants/export', [App\Http\Controllers\EventParticipantController::class, 'export'])->name('event-participants.export');
        Route::get('event-participants/print-all', [App\Http\Controllers\EventParticipantController::class, 'printAll'])->name('event-participants.printAll');
        Route::get('event-participants/print-current', [App\Http\Controllers\EventParticipantController::class, 'printCurrent'])->name('event-participants.printCurrent');
        Route::get('event-participants/{event_participant}/print', [App\Http\Controllers\EventParticipantController::class, 'printSingle'])->name('event-participants.print');

        // Event Staff Assignments
        Route::resource('event-staff-assignments', App\Http\Controllers\EventStaffAssignmentController::class);
        Route::get('event-staff-assignments/export', [App\Http\Controllers\EventStaffAssignmentController::class, 'export'])->name('event-staff-assignments.export');
        Route::get('event-staff-assignments/print-all', [App\Http\Controllers\EventStaffAssignmentController::class, 'printAll'])->name('event-staff-assignments.printAll');
        Route::get('event-staff-assignments/print-current', [App\Http\Controllers\EventStaffAssignmentController::class, 'printCurrent'])->name('event-staff-assignments.printCurrent');
        Route::get('event-staff-assignments/{event_staff_assignment}/print', [App\Http\Controllers\EventStaffAssignmentController::class, 'printSingle'])->name('event-staff-assignments.print');

        // Event Broadcasts
        Route::resource('event-broadcasts', App\Http\Controllers\EventBroadcastController::class);
        Route::get('event-broadcasts/export', [App\Http\Controllers\EventBroadcastController::class, 'export'])->name('event-broadcasts.export');
        Route::get('event-broadcasts/print-all', [App\Http\Controllers\EventBroadcastController::class, 'printAll'])->name('event-broadcasts.printAll');
        Route::get('event-broadcasts/print-current', [App\Http\Controllers\EventBroadcastController::class, 'printCurrent'])->name('event-broadcasts.printCurrent');
        Route::get('event-broadcasts/{event_broadcast}/print', [App\Http\Controllers\EventBroadcastController::class, 'printSingle'])->name('event-broadcasts.print');
...
Route::get('/clear-sessions-now', function() {
