...
Route::middleware(['auth', 'verified', 'role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value])
    ...
    ->group(function () {
        ...
        Route::get('suppliers/{supplier}/pdf-single', [App\Http\Controllers\Admin\SupplierController::class, 'generateSinglePdf'])->name('suppliers.generateSinglePdf');
        ...
        Route::get('inventory-items/{inventory_item}/pdf-single', [App\Http\Controllers\Admin\InventoryItemController::class, 'generateSinglePdf'])->name('inventory-items.generateSinglePdf');
        ...
        // Events
        Route::get('events/export', [EventController::class, 'export'])->name('events.export')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('events/print-all', [EventController::class, 'printAll'])->name('events.printAll')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('events/print-current', [EventController::class, 'printCurrent'])->name('events.printCurrent')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('events/{event}/print', [EventController::class, 'printSingle'])->name('events.print')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::resource('events', EventController::class)->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);

        // Eligibility Criteria
        Route::resource('eligibility-criteria', EligibilityCriteriaController::class)->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('eligibility-criteria/export', [EligibilityCriteriaController::class, 'export'])->name('eligibility-criteria.export')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('eligibility-criteria/print-all', [EligibilityCriteriaController::class, 'printAll'])->name('eligibility-criteria.printAll')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('eligibility-criteria/print-current', [EligibilityCriteriaController::class, 'printCurrent'])->name('eligibility-criteria.printCurrent')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('eligibility-criteria/{eligibility_criterion}/print', [EligibilityCriteriaController::class, 'printSingle'])->name('eligibility-criteria.print')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);

        Route::resource('event-recommendations', EventRecommendationController::class)->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-recommendations/export', [EventRecommendationController::class, 'export'])->name('event-recommendations.export')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-recommendations/print-all', [EventRecommendationController::class, 'printAll'])->name('event-recommendations.printAll')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-recommendations/print-current', [EventRecommendationController::class, 'printCurrent'])->name('event-recommendations.printCurrent')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-recommendations/{event_recommendation}/print', [EventRecommendationController::class, 'printSingle'])->name('event-recommendations.print')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);

        // Event Participants
        Route::resource('event-participants', EventParticipantController::class)->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-participants/export', [EventParticipantController::class, 'export'])->name('event-participants.export')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-participants/print-all', [EventParticipantController::class, 'printAll'])->name('event-participants.printAll')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-participants/print-current', [EventParticipantController::class, 'printCurrent'])->name('event-participants.printCurrent')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-participants/{event_participant}/print', [EventParticipantController::class, 'printSingle'])->name('event-participants.print')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);

        // Event Staff Assignments
        Route::resource('event-staff-assignments', EventStaffAssignmentController::class)->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-staff-assignments/export', [EventStaffAssignmentController::class, 'export'])->name('event-staff-assignments.export')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-staff-assignments/print-all', [EventStaffAssignmentController::class, 'printAll'])->name('event-staff-assignments.printAll')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-staff-assignments/print-current', [EventStaffAssignmentController::class, 'printCurrent'])->name('event-staff-assignments.printCurrent')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-staff-assignments/{event_staff_assignment}/print', [EventStaffAssignmentController::class, 'printSingle'])->name('event-staff-assignments.print')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);

        // Event Broadcasts
        Route::resource('event-broadcasts', EventBroadcastController::class)->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-broadcasts/export', [EventBroadcastController::class, 'export'])->name('event-broadcasts.export')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-broadcasts/print-all', [EventBroadcastController::class, 'printAll'])->name('event-broadcasts.printAll')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-broadcasts/print-current', [EventBroadcastController::class, 'printCurrent'])->name('event-broadcasts.printCurrent')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
        Route::get('event-broadcasts/{event_broadcast}/print', [EventBroadcastController::class, 'printSingle'])->name('event-broadcasts.print')->middleware('role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value);
