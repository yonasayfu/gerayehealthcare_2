...
Route::middleware(['auth', 'verified', 'role:' . RoleEnum::SUPER_ADMIN->value . '|' . RoleEnum::ADMIN->value])
    ...
    ->group(function () {
        ...
        // --- CORRECTED: Leave Request Management for Admins ---
        Route::resource('leaveRequests', AdminLeaveRequestController::class)
            ->only(['index', 'update']);
...
Route::middleware(['auth', 'verified', 'role:' . RoleEnum::STAFF->value])
    ...
    ->group(function () {
        ...
        // --- CORRECTED: Leave Request Management for Staff ---
        Route::resource('leaveRequests', StaffLeaveRequestController::class)
            ->only(['index', 'store']);
    });
