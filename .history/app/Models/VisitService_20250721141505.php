...
class VisitService extends Model
{
    ...
    protected $fillable = [
        ...
        'check_out_latitude',
        'check_out_longitude',
        'cost', // Add cost to fillable
        'service_id', // Add service_id to fillable
    ];
    ...
    protected $casts = [
        ...
        'cost' => 'decimal:2', // Cast cost to decimal
    ];
    ...
    /**
     * Get the invoice items associated with the visit service.
     */
