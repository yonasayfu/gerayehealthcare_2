...
class StaffIsAvailableForShift implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        if (!$isAvailable) {
            $this->conflictMessage = 'The staff member is not available for the selected time slot. Ensure they have an "Available" slot that covers the entire shift duration.';
            $fail($this->conflictMessage);
            return;
        }
    }
