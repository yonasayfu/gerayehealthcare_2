...
class ExportConfig
{
    ...
    public static function getPatientConfig(): array
    {
        return [
            ...
            'pdf' => [
                'view' => 'exports.patients.pdf', // Added view for PDF export
            ...
            'print_current' => [
                'view' => 'exports.patients.current_page_pdf', // Added view for print current
            ...
            'print_all' => [
                'view' => 'exports.patients.all_records_pdf', // Added view for print all
            ...
            'single_record' => [
                'filename_prefix' => 'patient-record', // Added for single record PDF
                'fields' => [
                    'Full Name' => 'full_name',
