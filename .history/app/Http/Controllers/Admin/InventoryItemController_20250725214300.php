...
class InventoryItemController extends Controller
{
    ...
    public function export(Request $request): StreamedResponse
    {
        ...
        // Default to PDF if no type or 'pdf' is specified (though generatePdf should be called directly for PDF)
        // This part might be redundant if generatePdf is called directly from frontend, but kept for robustness.
