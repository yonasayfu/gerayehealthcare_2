    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'shift_start' => [
                'required',
                'date',
                new StaffIsAvailableForShift($request->staff_id, $request->input('shift_end'))
            ],
        ]);
    ...
    public function update(Request $request, CaregiverAssignment $assignment)
    {
        ...
        $request->validate([
            ...
            'shift_start' => [
                'required',
                'date',
                new StaffIsAvailableForShift($request->staff_id, $request->input('shift_end'), $assignment->id)
            ],
        ]);
