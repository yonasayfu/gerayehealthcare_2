...
class PatientController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'fayda_id' => 'nullable|string|max:255|unique:patients,fayda_id', // <-- ADD THIS LINE
    ...
    /**
     * This method can be removed as uniqueness is no longer required.
     */
     ...
     public function update(Request $request, Patient $patient)
    {
        $data = $request->validate([
            'full_name' => 'required|string|max:255',
            // This rule ensures the fayda_id is unique, except for the current patient
            'fayda_id' => ['nullable', 'string', 'max:255', Rule::unique('patients')->ignore($patient->id)], // <-- ADD THIS LINE
            'date_of_birth' => 'nullable|date',
            'gender' => 'nullable|string|max:10',
            'address' => 'nullable|string',
            'phone_number' => 'nullable|numeric',
