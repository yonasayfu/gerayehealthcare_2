...
class MarketingAnalyticsController extends Controller
{
    public function dashboardData(Request $request)
    {
        ...
        return Inertia::render('Admin/MarketingAnalytics/Dashboard', [
            'dashboardStats' => [
            ...
            // Other props that Dashboard.vue expects, but are not calculated in dashboardData method
            // These will need to be passed from their respective methods or initialized as empty/default values
