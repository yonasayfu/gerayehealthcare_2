...
class InvoiceController extends Controller
{
    ...
    {
        // Eager load patient and invoice items with their associated visit services
        $invoice->load('patient', 'items.visitService');

        // Manually create a 'visit_services' collection from invoice items for frontend compatibility
        $invoice->visit_services = $invoice->items->map(function ($item) {
            return $item->visitService;
