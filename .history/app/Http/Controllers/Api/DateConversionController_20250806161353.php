...
use Andegna\DateTime; // Explicitly import Andegna\DateTime
...
class DateConversionController extends Controller
{
    ...
    public function convertToGregorian(Request $request)
    {
        ...
        try {
            ...
            Log::info('Ethiopian date parts for conversion:', ['parts' => $parts, 'year_type' => gettype(intval($parts[0])), 'month_type' => gettype(intval($parts[1])), 'day_type' => gettype(intval($parts[2]))]);
            // Reverting to direct constructor call, ensuring fully qualified namespace
