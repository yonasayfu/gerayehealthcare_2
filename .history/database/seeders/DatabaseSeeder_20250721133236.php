...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->call([
            ...
            TestInvoiceSeeder::class, // Add the new seeder here
        ]);

        // Create sample data using factories (if not already covered by specific seeders)
        // \App\Models\VisitService::factory(15)->create(); // This might conflict with TestInvoiceSeeder
