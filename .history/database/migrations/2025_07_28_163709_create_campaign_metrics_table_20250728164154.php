// database/migrations/xxxx_xx_xx_xxxxxx_create_campaign_metrics_table.php
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('campaign_metrics', function (Blueprint $table) {
            $table->id();
            $table->foreignId('campaign_id')->constrained('marketing_campaigns')->onDelete('cascade'); // FK to marketing_campaigns
            $table->date('date');
