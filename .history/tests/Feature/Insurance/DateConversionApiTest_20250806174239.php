...
class DateConversionApiTest extends TestCase
{
    ...
    public function it_can_convert_gregorian_to_ethiopian_date()
    {
        ...
        $response = $this->postJson('/api/convert-gregorian-to-ethiopian', $gregorianDate);
    ...
    public function it_can_convert_ethiopian_to_gregorian_date()
    {
        ...
        $response = $this->postJson('/api/convert-ethiopian-to-gregorian', $ethiopianDate);
    ...
    public function it_returns_error_for_invalid_ethiopian_date()
    {
        ...
        $response = $this->postJson('/api/convert-ethiopian-to-gregorian', $invalidEthiopianDate);
