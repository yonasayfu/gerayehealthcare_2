...
class VisitServiceTest extends TestCase
{
    ...
    public function it_saves_the_correct_assignment_id_when_creating_a_visit(): void
    {
        ...
        // --- THE FINAL FIX: Create the assignment directly ---
        // This bypasses any issues with the factory and guarantees
        // the record exists with the correct status.
        $assignment = CaregiverAssignment::create([
            'patient_id' => $patient->id,
            'staff_id' => $staff->id,
            'status' => 'Assigned', // We guarantee the status is 'Assigned'
            'shift_start' => now(),
