...
class VisitServiceTest extends TestCase
{
    ...
    public function it_saves_the_correct_assignment_id_when_creating_a_visit(): void
    {
        ...
        // Create a staff member with a role that is NOT 'Admin',
        // so the CaregiverAssignmentFactory can find them.
        $staff = Staff::factory()->create(['role' => 'Nurse']);

        // This will now succeed because the factory can find the 'Nurse'
