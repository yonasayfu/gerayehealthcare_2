    ...
    <div class="container mx-auto p-4 md:p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 transform transition duration-500 hover:scale-[1.02] card-hover animate-fadeIn" style="animation-delay: 1.2s">
          ...
          <div x-data="{
              // Initialize chartData as an empty array within Alpine's scope
              chartData: [],
              ...
              getChartWidthStyle() {
                  ...
                  // Calculate width based on the number of bars, similar to the original Alpine.js logic
                  return `width: ${ 100 - (1 / this.chartData.length) * 100 + 3}%;`;
              }
          }"
          x-init="chartData = [{{ safeConversionFunnelData.New }}, {{ safeConversionFunnelData.Contacted }}, {{ safeConversionFunnelData.Qualified }}, {{ safeConversionFunnelData.Converted }}]"
          x-cloak class="px-4">
