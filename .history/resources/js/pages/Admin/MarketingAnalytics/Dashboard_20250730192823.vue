...
const alpineConversionFunnelData = computed(() => {
  const data = props.conversionFunnelData || { New: 0, Contacted: 0, Qualified: 0, Converted: 0 };
  const chartValues = [
    data.New,
    data.Contacted,
    data.Qualified,
  ...
  const chartLabels = ['New', 'Contacted', 'Qualified', 'Converted'];
  ...
  return {
    ...
    // Helper to calculate width safely even if chartData is empty
    getChartWidthStyle() {
    ...
    <div class="container mx-auto p-4 md:p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 transform transition duration-500 hover:scale-[1.02] card-hover animate-fadeIn" style="animation-delay: 1.2s">
          ...
          <div :x-data="JSON.stringify(alpineConversionFunnelData)" x-cloak class="px-4">
