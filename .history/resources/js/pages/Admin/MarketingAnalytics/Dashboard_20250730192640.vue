...
// Alpine.js data for the Conversion Funnel Bar Chart
const alpineConversionFunnelData = computed(() => ({
  chartData: [
    props.conversionFunnelData.New,
    props.conversionFunnelData.Contacted,
    props.conversionFunnelData.Qualified,
    props.conversionFunnelData.Converted,
  ],
    ...
    <div class="container mx-auto p-4 md:p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 transform transition duration-500 hover:scale-[1.02] card-hover animate-fadeIn" style="animation-delay: 1.2s">
          ...
          <div x-data="alpineConversionFunnelData" x-cloak class="px-4">
              ...
              <div class="bg-white">
                ...
                <div class="line my-4 relative">
                  ...
                  <div class="flex -mx-2 items-end mb-2 h-[200px]"> <template x-for="(data, index) in chartData" :key="index">
                      <div class="px-2 w-1/4"> <div :style="`height: ${data > 0 ? (data / Math.max(...chartData)) * 100 : 0}%`"
