    ...
    <div class="flex-1 space-y-4 p-8 pt-6">
      ...
      <div class="gap-4 space-y-4 md:grid-cols-2 lg:grid lg:grid-cols-7 lg:space-y-0">
        ...
        <div data-slot="card" class="bg-card text-card-foreground flex flex-col gap-6 rounded-xl border py-6 col-span-3">
          ...
          <div data-slot="card-content" class="px-6">
            <div data-slot="chart" data-chart="chart-«r3n»" class="[&_.recharts-cartesian-axis-tick_text]:fill-muted-foreground [&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-border/50 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-border [&_.recharts-polar-grid_[stroke='#ccc']]:stroke-border [&_.recharts-radial-bar-background-sector]:fill-muted [&_.recharts-rectangle.recharts-tooltip-cursor]:fill-muted [&_.recharts-reference-line_[stroke='#ccc']]:stroke-border flex justify-center text-xs [&_.recharts-dot[stroke='#fff']]:stroke-transparent [&_.recharts-layer]:outline-hidden [&_.recharts-sector]:outline-hidden [&_.recharts-sector[stroke='#fff']]:stroke-transparent [&_.recharts-surface]:outline-hidden [&_.recharts-pie-label-text]:fill-foreground mx-auto aspect-square max-h-[400px] pb-0">
              <style>
                [data-chart=chart-«r3n»] {
                  --color-cardiology: var(--chart-1);
                  --color-neurology: var(--chart-2);
                  --color-oncology: var(--chart-3);
                  --color-pediatrics: var(--chart-4);
                }
                .dark [data-chart=chart-«r3n»] {
                  --color-cardiology: var(--chart-1);
                  --color-neurology: var(--chart-2);
                  --color-oncology: var(--chart-3);
                  --color-pediatrics: var(--chart-4);
