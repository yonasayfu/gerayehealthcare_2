...
// Destructure props so `taskDelegations` is never undefined
    ...
    <div class="space-y-6 p-6">
      ...
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-muted/40 p-4 rounded-lg shadow">
        <div>
          ...
          <p class="text-sm text-muted-foreground">Assign and manage tasks.</p>
        </div>
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-6 py-4 text-right">
                <Link :href="route('admin.task-delegations.edit', { task_delegation: task.id })" class="text-blue-600 mr-2">
                  <Edit3 />
                </Link>
                <button @click="destroy(task.id)" class="text-red-600">
                  <Trash2 />
                </button>
              </td>
            </tr>
