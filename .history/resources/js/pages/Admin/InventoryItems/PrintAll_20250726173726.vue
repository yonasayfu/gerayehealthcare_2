...
<template>
  <Head :title="Array.isArray(props.inventoryItem) ? 'Print All Inventory Items' : `Print Inventory Item: ${!Array.isArray(props.inventoryItem) && props.inventoryItem ? props.inventoryItem.name : ''}`" />

  <div class="print-document">
    <div class="print-header">
      <img src="/images/geraye_logo.jpeg" alt="Geraye Healthcare Logo" style="max-width: 150px; margin-bottom: 10px;">
      <h1>{{ Array.isArray(props.inventoryItem) ? 'All Inventory Items' : `Inventory Item: ${!Array.isArray(props.inventoryItem) && props.inventoryItem ? props.inventoryItem.name : ''}` }}</h1>
