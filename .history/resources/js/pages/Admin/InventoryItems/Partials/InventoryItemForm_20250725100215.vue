...
import { Label, Input, Textarea, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Calendar, Popover, PopoverContent, PopoverTrigger, Button } from 'reka-ui'
...
const clearPhoto = () => {
  props.form.photo = null;
  props.form.existing_photo_path = null;
  props.form.clear_photo = true; // Set flag to inform backend to clear photo
};
</script>
