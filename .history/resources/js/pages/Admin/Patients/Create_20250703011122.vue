    ...
    <div class="p-6 space-y-6">
      ...
      <div class="rounded-lg border border-border bg-white dark:bg-background p-6 shadow-sm space-y-6">
        ...
        <div class="flex flex-col items-end space-y-2">
          <div v-if="validating" class="text-sm text-gray-500 italic">
            Validating input...
          </div>
          ...
          <div class="flex space-x-3">
            ...
            <button
              @click="submit"
              :disabled="form.processing || validating || localErrors.email || localErrors.phone_number"
              class="inline-flex items-center px-5 py-2 bg-green-600 hover:bg-green-700 text-white rounded-md text-sm font-medium transition disabled:cursor-not-allowed disabled:opacity-70"
            >
