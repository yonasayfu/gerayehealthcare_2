        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <select
              ...
              class="shadow-sm border border-gray-300 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 bg-white dark:bg-gray-700 dark:text-white"
            >
              <option :value="null" class="text-gray-900 dark:text-white">Select Employer</option>
              <option v-for="client in corporateClients" :key="client.id" :value="client.id" class="text-gray-900 dark:text-white">{{ client.name }}</option>
            </select>
