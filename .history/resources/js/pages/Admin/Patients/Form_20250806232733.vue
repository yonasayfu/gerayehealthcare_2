        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <select
              ...
              class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 dark:text-white sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 dark:bg-gray-700"
            >
              <option :value="null" class="bg-white text-gray-900 dark:bg-gray-700 dark:text-white">Select Policy</option>
              <option v-for="policy in insurancePolicies" :key="policy.id" :value="policy.id" class="bg-white text-gray-900 dark:bg-gray-700 dark:text-white">{{ policy.service_type }} ({{ policy.coverage_percentage }}%) - {{ policy.corporate_client?.name }}</option>
            </select>
