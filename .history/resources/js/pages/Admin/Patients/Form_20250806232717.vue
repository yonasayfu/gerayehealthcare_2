      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            ...
            >
              <option :value="null" class="bg-white text-gray-900 dark:text-white">Select Employer</option>
              <option v-for="client in corporateClients" :key="client.id" :value="client.id" class="bg-white text-gray-900 dark:text-white">{{ client.name }}</option>
            </select>
