...
import '@/css/app.css'; /Users/yonassayfu/Herd/Geraye/resources/css/app.css// Adjust this path if necessary
...
onMounted(() => {
  // Set up a listener to close the window AFTER the print dialog is dismissed
  // This fires whether the user prints or cancels the print operation.
  window.onafterprint = () => {
    window.close();
  };
