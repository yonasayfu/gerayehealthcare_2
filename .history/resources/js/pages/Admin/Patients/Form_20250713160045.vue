...
// Corrected import paths: changed 'components' to 'Components'
import InputError from '@/Components/InputError.vue' // Corrected
import InputLabel from '@/Components/InputLabel.vue' // Corrected
import TextInput from '@/Components/TextInput.vue'     // Corrected
import { Calendar as CalendarIcon } from 'lucide-vue-next'
import { format } from 'date-fns'
import { Calendar } from '@/Components/ui/calendar'     // Corrected
import { Popover, PopoverContent, PopoverTrigger } from '@/Components/ui/popover' // Corrected
import { cn } from '@/lib/utils' // Assuming this path is correct if your utils are in lib
