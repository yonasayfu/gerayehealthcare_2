...
<div id="print-header" class="print-only hidden">
  <h1 class="text-xl font-bold text-center mb-4">Geraye Home-to-Home Care</h1>
  <p class="text-center text-sm text-gray-600">Patient Records Export</p>
