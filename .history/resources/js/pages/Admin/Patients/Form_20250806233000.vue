        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            ...
            >
              ...
              <option v-for="policy in insurancePolicies" :key="policy.id" :value="policy.id" class="text-gray-900 dark:text-white">{{ policy.service_type }} ({{ policy.coverage_percentage }}%) - {{ policy.corporate_client?.name }}</option>
            </select>
