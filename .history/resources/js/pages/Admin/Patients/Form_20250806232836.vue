      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <select
              ...
              class="shadow-sm border border-gray-300 text-black sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 dark:bg-gray-700 dark:text-white"
            >
        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            ...
            >
              ...
              <option v-for="policy in insurancePolicies" :key="policy.id" :value="policy.id">{{ policy.service_type }} ({{ policy.coverage_percentage }}%) - {{ policy.corporate_client?.name }}</option>
            </select>
        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <select
              v-model="form.corporate_client_id"
              class="shadow-sm border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 bg-white dark:bg-gray-700 dark:text-white"
            >
              <option :value="null">Select Employer</option>
              <option v-for="client in corporateClients" :key="client.id" :value="client.id">{{ client.name }}</option>
            </select>
        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <select
              v-model="form.policy_id"
              class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5 dark:bg-gray-700 dark:text-white"
            >
              <option :value="null">Select Policy</option>
              <option v-for="policy in insurancePolicies" :key="policy.id" :value="policy.id">{{ policy.service_type }} ({{ policy.coverage_percentage }}%) - {{ policy.corporate_client?.name }}</option>
            </select>
