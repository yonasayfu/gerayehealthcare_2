...
const props = defineProps<{
  assignment: { id: number, patient_id: number, staff_id: number, shift_start: string, shift_end: string, status: string },
...
const breadcrumbs: BreadcrumbItemType[] = [
  ...
  { title: 'Edit', href: route('admin.assignments.edit', props.assignment.id) }, // updated
]
...
function submit() {
  form.put(route('admin.assignments.update', props.assignment.id))
}
</script>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-6 space-y-6">
      ...
      <div class="rounded-lg bg-muted/40 p-4 shadow-sm">
        ...
        <p class="text-sm text-muted-foreground">Update the assignment details below.</p>
      </div>
      ...
      <div class="flex justify-end space-x-3">
        ...
        <button
          ...
          class="inline-flex items-center px-5 py-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white font-semibold rounded-md shadow-sm"
        >
