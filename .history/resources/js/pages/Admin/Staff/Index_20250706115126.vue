...
function destroy(id: number) {
  if (confirm('Are you sure you want to delete this staff?')) {
    router.delete(route('adminstaff.destroy', id))
  }
}
...
<template>
  ...
  <FileText class="w-4 h-4" />
                  ...
                  <Link :href="route('staff.edit', member.id)" class="inline-flex items-center justify-center w-8 h-8 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900 text-blue-600" title="Edit">
                    <Edit3 class="w-4 h-4" />
                  </Link>
