...
function submit() {
  // Use form.post for file uploads, with _method spoofing for PUT
  // Inertia's useForm handles the method spoofing when you use .post with _method
  form.post(`/dashboard/staff/${props.staff.id}`, {
    _method: 'put', // Spoof the PUT request
    onSuccess: () => {
