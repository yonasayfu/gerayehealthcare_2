...
const form = useForm<InvoiceFormData>({
  patient_id: props.selectedPatientId ? parseInt(props.selectedPatientId) : null, // Keep as number for backend
  visit_ids: [],
...
const handlePatientSelected = (newPatientId: string | null) => {
  ...
  form.patient_id = newPatientId ? parseInt(newPatientId) : null; // Update form's patient_id
    preserveState: true,
    replace: true,
  });
};
