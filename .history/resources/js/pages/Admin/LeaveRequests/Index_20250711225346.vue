...
// Destructure props so `staff` is never undefined
const { staff, filters } = defineProps<{
  staff: {
    data: Array<{
      id: number
      first_name: string
...
const sortDirection = ref(filters.direction)
const perPage       = ref(filters.per_page)

// Watch & debounce to reload index when filters change
