...
function exportData(type: 'csv' | 'pdf') {
  window.open(route('admin.employee-insurance-records.export', { type }), '_blank');
}
...
const printAllRecords = () => {
    window.open(route('admin.employee-insurance-records.printAll', { type: 'pdf' }), '_blank');
};
          ...
          <thead class="bg-gray-100 dark:bg-gray-800 text-xs uppercase text-muted-foreground print-table-header">
            <tr>
              ...
              <th class="px-6 py-3 cursor-pointer" @click="toggleSort('federal_id')">
                Federal ID <ArrowUpDown class="inline w-4 h-4 ml-1 print:hidden" />
              </th>
...
@media print {
  ...
  .print-table th:nth-child(1), .print-table td:nth-child(1) { width: 14%; } /* Kebele ID */
  .print-table th:nth-child(2), .print-table td:nth-child(2) { width: 12%; } /* Woreda */
  .print-table th:nth-child(3), .print-table td:nth-child(3) { width: 12%; } /* Region */
  .print-table th:nth-child(4), .print-table td:nth-child(4) { width: 12%; } /* Federal ID */
  .print-table th:nth-child(5), .print-table td:nth-child(5) { width: 18%; } /* Ministry Department */
  .print-table th:nth-child(6), .print-table td:nth-child(6) { width: 15%; } /* Employee ID Number */
  .print-table th:nth-child(7), .print-table td:nth-child(7) { width: 8%; }  /* Verified */
