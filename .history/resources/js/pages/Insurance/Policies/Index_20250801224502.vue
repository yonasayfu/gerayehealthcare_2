...
function exportData(type: 'csv' | 'pdf') {
  window.open(route('admin.insurance-policies.export', { type }), '_blank');
}
...
const printAllPolicies = () => {
    window.open(route('admin.insurance-policies.printAll', { type: 'pdf' }), '_blank');
};
    ...
    <div class="space-y-6 p-6 print:p-0 print:space-y-0">
      ...
      <div class="rounded-lg bg-muted/40 p-4 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-4 print:hidden">
        ...
        <div class="flex flex-wrap gap-2">
          <Link :href="route('admin.insurance-policies.create')" class="inline-flex items-center gap-2 bg-cyan-600 hover:bg-cyan-700 text-white text-sm px-4 py-2 rounded-md transition">
            + Add Policy
          </Link>
          ...
          <button @click="printAllPolicies" class="inline-flex items-center gap-1 text-sm px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-200">
...
@media print {
  ...
  .print-table th:nth-child(1), .print-table td:nth-child(1) { width: 18%; } /* Service Type */
  .print-table th:nth-child(2), .print-table td:nth-child(2) { width: 12%; } /* Coverage Percentage */
  .print-table th:nth-child(3), .print-table td:nth-child(3) { width: 15%; } /* Coverage Type */
  .print-table th:nth-child(4), .print-table td:nth-child(4) { width: 8%; }  /* Is Active */
