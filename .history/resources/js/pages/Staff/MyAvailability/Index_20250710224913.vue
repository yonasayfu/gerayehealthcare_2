...
const submitForm = () => {
    ...
    if (isEditMode.value) {
        transformedForm.put(route('staff.my-availability.update', { availability: form.id }), { onSuccess: onFinish, preserveScroll: true });
    } else {
        transformedForm.post(route('staff.my-availability.store'), { onSuccess: onFinish, preserveScroll: true });
    }
};
