...
import {
  ...
  ChevronRight, CalendarCheck, UserCheck, Settings, DollarSign, CalendarOff // <-- ADD CalendarOff ICON
...
const allAdminNavItems = [
  ...
  communicationNavGroup,
  {
    ...
    items: [
      ...
      // --- NEW LINK FOR ADMINS ---
      { title: 'Leave Requests', routeName: 'admin.LeaveRequest.index', icon: CalendarOff },
    ],
  },
  {
    group: 'Integrations',
        ...
        return [
            {
                ...
                items: [
                    ...
                    // --- NEW LINK FOR STAFF ---
                    { title: 'My Leave Requests', routeName: 'staff.LeaveRequest.index', icon: CalendarOff }
                ]
            },
            communicationNavGroup,
        ];
