    ...
    <header class="bg-background/50 flex h-14 items-center gap-3 px-4 backdrop-blur-xl lg:h-[60px]">
        ...
        <div class="flex items-center gap-2 sm:gap-4 shrink-0">
            ...
            <div class="relative">
                ...
                <div v-if="showNotifications" ref="notificationDropdown" class="absolute right-2 mt-8 w-0 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 dark:bg-gray-800 z-50">
