...
const allAdminNavItems = [
  ...
  communicationNavGroup,
  {
    ...
    items: [
      ...
      // --- DEBUGGING: Using simplified route name ---
      { title: 'Leave Requests', routeName: 'admin.leave_requests_index', icon: CalendarOff },
    ],
  },
  {
    group: 'Integrations',
        ...
        return [
            {
                ...
                items: [
                    ...
                    // --- DEBUGGING: Using simplified route name ---
                    { title: 'My Leave Requests', routeName: 'staff.leave_requests_index', icon: CalendarOff }
                ]
            },
            communicationNavGroup,
        ];
