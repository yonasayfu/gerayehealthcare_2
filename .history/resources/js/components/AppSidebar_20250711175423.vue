...
import {
  ...
  ChevronRight, CalendarCheck, UserCheck, Settings, DollarSign,
...
const allAdminNavItems = [
  ...
  communicationNavGroup,
  {
    ...
    items: [
      ...
      { title: 'Staff Leave', routeName: 'admin.staff-availabilities.index', icon: CalendarCheck, permission: 'view staff' },
    ],
  },
  {
    group: 'Integrations',
