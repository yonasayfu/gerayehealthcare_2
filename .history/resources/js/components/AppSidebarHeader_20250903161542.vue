...
const handleClickOutside = (event: MouseEvent) => {
    if (
        ...
        !notificationBell.value.contains(event.target as Node) &&
...
onMounted(() => {
    ...
    watch(() => showNotifications.value, async (open) => {
        console.log('showNotifications changed:', open);
...
<template>
    <header class="bg-background/1950 flex h-14 items-center gap-3 px-4 backdrop-blur-xl lg:h-[60px]">
        ...
        <div class="flex items-center gap-2 sm:gap-4 shrink-0">
            ...
            <div class="relative">
                ...
                <div v-if="showNotifications" ref="notificationDropdown" class="absolute right-0 mt-2 w-80 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 dark:bg-gray-800 z-50">
                    <div class="border-b px-4 py-3 text-sm font-semibold text-gray-800 dark:border-gray-700 dark:text-gray-100 flex justify-between items-center">
