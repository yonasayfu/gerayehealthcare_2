...
<style scoped>
/*
  The 'truncate' class should ideally be handled by the SidebarMenuButton
  when the sidebar is collapsed. This media query might still be useful
  for general responsiveness if elements truncate at certain breakpoints.
*/
