      ...
      <div class="flex-grow flex">
        ...
        <div class="w-2/3 flex flex-col bg-white dark:bg-gray-800">
          <template v-if="selectedConversation">
            ...
            <!-- Message Input Form -->
            <div v-if="selectedConversation?.id" class="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
              {{ console.log('Rendering message input form for conversation ID:', selectedConversation?.id) }}
