...
const iconBgClass = computed(() => {
  switch (props.color) {
    ...
    case 'purple':
        return 'bg-purple-200 dark:bg-purple-950 text-purple-800 dark:text-purple-300';
    case 'orange':
        return 'bg-orange-200 dark:bg-orange-950 text-orange-800 dark:text-orange-300';
    case 'indigo':
