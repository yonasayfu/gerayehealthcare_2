          ...
          <template v-else>
            ...
            <div class="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
              <form @submit.prevent="submit" class="flex items-center gap-3">
                <img :src="authUser.profile_photo_url || `https://ui-avatars.com/api/?name=${authUser.name}&color=7F9CF5&background=EBF4FF`" :alt="authUser.name" class="w-10 h-10 rounded-full mr-2 object-cover">
                <input
