...
<template>
  <div v-if="props.isOpen" class="fixed bottom-6 right-6 z-50 chat-modal-widget">
    ...
    >
      ...
      <div class="flex-grow flex min-h-0">
        ...
        <div class="w-1/3 flex flex-col bg-gray-100 dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div class="flex-grow overflow-y-auto custom-scrollbar">
            ...
            >
              <img :src="convo.profile_photo_url || `https://ui-avatars.com/api/?name=${convo.name}&color=7F9CF5&background=EBF4FF`" :alt="convo.name" class="w-10 h-10 rounded-full object-cover flex-shrink-0">
              <div v-if="!convo.profile_photo_url" class="w-10 h-10 rounded-full bg-indigo-200 dark:bg-indigo-700 flex items-center justify-center text-indigo-800 dark:text-indigo-200 text-sm font-medium flex-shrink-0">
            ...
            <div class="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
              <form @submit.prevent="submit" class="flex items-center gap-3">
                ...
                <input
                  ...
                  autocomplete="off"
                />
                <a href="#" @click.prevent class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition">
      ...
      <!-- Resize handle -->
      <div class="resize-handle absolute -bottom-2 -right-2 w-8 h-8 cursor-se-resize flex items-center justify-center text-gray-400 hover:text-gray-600 dark:text-gray-600 dark:hover:text-gray-400 transition">
      </div>
    </div>
  </div>
</template>
