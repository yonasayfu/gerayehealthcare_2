...
// State for tracking open groups
...
<template>
  <Sidebar collapsible="icon" class="border-r bg-background">
    ...
    <SidebarContent class="space-y-1 px-2">
      ...
      <!-- <div class="px-2 mb-2">
        <Input placeholder="Search..." class="text-xs" />
      </div> -->

      <SidebarMenu>
        <div v-for="group in mainNavItems" :key="group.group" class="space-y-1">
          <Collapsible
...
<style scoped>
/* Optional: Add smooth collapse animation */
