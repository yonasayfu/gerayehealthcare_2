...
import {
  ...
  ChevronRight, CalendarCheck, UserCheck, Settings, DollarSign, CalendarOff // CalendarOff icon added
...
const allAdminNavItems = [
  ...
  communicationNavGroup,
  {
    ...
    items: [
      ...
      { title: 'Leave Requests', routeName: 'admin.leave-requests.index', icon: CalendarOff }, // Admin Leave Requests
    ],
  },
  {
    group: 'Integrations',
        ...
        return [
            {
                ...
                items: [
                    ...
                    { title: 'My Leave Requests', routeName: 'staff.leave-requests.index', icon: CalendarOff } // Staff Leave Requests
                ]
            },
            communicationNavGroup,
        ];
