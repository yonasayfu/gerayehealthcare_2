...
const allAdminNavItems = [
  ...
  communicationNavGroup, // Add the group here for admins
  {
        ...
        return [
            {
                ...
                items: [
                    ...
                    { title: 'My Messages', routeName: 'messages.index', icon: MessageCircle },
                    { title: 'My Patients', routeName: 'staff.my-patients.index', icon: UserPlus },
                    { title: 'My Tasks', routeName: 'staff.my-tasks.index', icon: ClipboardList },
                    { title: 'My Documents', routeName: 'staff.my-documents.index', icon: Folder },
                    { title: 'My Schedule', routeName: 'staff.my-schedule.index', icon
                    { title: 'My Availability', routeName: 'staff.my-availability.index', icon: UserCheck }
                ]
            },
            communicationNavGroup, // Also add the group here for staff
        ];
    }
    return [];
});
