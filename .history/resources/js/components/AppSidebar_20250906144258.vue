  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Event Staff Assignments', routeName: 'admin.event-staff-assignments.index', icon: UserCog, permission: 'view event staff assignments' },
         { title: 'Event Participant', routeName: 'admin.event-participants.index', icon: Users, permission: 'view event participants' },', icon: Megaphone, permission: 'view event broadcasts' },
