...
// Simple boolean ref for each group - no complex reactivity
...
onMounted(() => {
  ...
  mainNavItems.value.forEach(group => {
    initialStates[group.group] = false
  })
                ...
                <div class="group/collapsible">
                    ...
                    >
                        ...
                        <ChevronRight
                            ...
                            :class="{ 'rotate-90': openGroups[group.group] }"
                        />
                    </div>
                    
                    <!-- Manual content visibility -->
                    <div 
                        v-show="openGroups[group.group]"
                        class="overflow-hidden transition-all duration-200 ease-in-out"
                        :class="{
                            'max-h-96 opacity-100': openGroups[group.group],
                            'max-h-0 opacity-0': !openGroups[group.group]
                        }"
                    >
...
/* Fix for collapsed sidebar text issues */
