...
onMounted(async () => {
  ...
  if (todayEthiopian) {
    ...
    // Fallback if conversion fails, perhaps set to a default Ethiopian date
    currentEthiopianYear.value = 2016; // Example: Ethiopian year 2016
    currentEthiopianMonth.value = 1; // Example: Meskerem
  }
