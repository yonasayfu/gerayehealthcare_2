...
const allAdminNavItems: SidebarNavGroup[] = [
  ...
  },
  {
    ...
    icon: Warehouse,
    items: [
      { title: 'Requests', routeName: 'admin.inventory-items.index', icon: Package, permission: 'view inventory items' },
      { title: 'Suppliers', routeName: 'admin.suppliers.index', icon: UserPlus, permission: 'view suppliers' },
      { title: 'Inventory Items Requests', routeName: 'admin.inventory-requests.index', icon: FileText, permission: 'view inventory requests' },
