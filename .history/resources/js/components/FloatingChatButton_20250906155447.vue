...
<template>
  <div class="fixed bottom-4 right-4 z-50">
    <button
      @click="toggleChat()"
      class="relative bg-green-400 hover:bg-green-500 text-white rounded-full p-4 shadow-lg focus:outline-none focus:ring-2 focus:ring--500 focus:ring-offset-2"
    >
