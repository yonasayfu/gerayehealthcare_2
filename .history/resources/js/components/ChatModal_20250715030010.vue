...
<template>
  <div v-if="props.isOpen" class="fixed bottom-6 right-6 z-50 chat-modal-widget">
    <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-[400px] h-[600px] flex flex-col overflow-hidden resize" style="min-width: 300px; min-height: 400px;">
      <!-- Header -->
