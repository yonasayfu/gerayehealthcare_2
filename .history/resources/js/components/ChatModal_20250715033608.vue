...
import { Send, X, MessageSquareText, Search, Minus, GripCorner } from 'lucide-vue-next';
          ...
          <template v-else>
            ...
            <div class="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
              <form @submit.prevent="submit" class="flex items-center gap-3">
                <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp" alt="avatar" class="w-10 h-10 rounded-full mr-2">
                <input
