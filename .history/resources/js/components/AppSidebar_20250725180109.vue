...
const initializeOpenGroups = () => {
  ...
  mainNavItems.value.forEach(group => {
    initialStates[group.group] = true
  })
  openGroups.value = initialStates
}
...
// Initialize open groups when mainNavItems changes
watch(mainNavItems, () => {
    ...
    <SidebarContent>
        <SidebarMenu>
            <div v-for="group in mainNavItems" :key="group.group" class="mb-1">
                <Collapsible
                    v-model:open="openGroups[group.group]"
                    as-child
        ...
        <SidebarMenu>
            <SidebarMenuItem>
                ...
                >
                    <div class="flex items-center gap-2">
                        <component 
                            :is="areAllGroupsExpanded ? ChevronUp : ChevronDownIcon" 
                            class="h-4 w-4" 
                        />
