...
const expandAllGroups = () => {
  ...
  // Take only first 2 groups to respect the limit
  openGroups.value = allGroupNames.slice(0, 2)
}
        ...
        <SidebarMenu>
            <SidebarMenuItem>
                <SidebarMenuButton 
                    ...
                    class="w-full justify-between px-2 py-2 text-sm hover:bg-muted/30 rounded-md mb-1"
                >
            ...
            <SidebarMenuItem>
                ...
                >
                    <div class="flex items-center gap-2">
                        <Minimize2 class="h-4 w-4 flex-shrink-0" />
