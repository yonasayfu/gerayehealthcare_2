  ...
  <form @submit.prevent="emit('submit')">
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="sm:col-span-3">
          ...
          <div class="mt-2">
            <input
              ...
              class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
            />
            <div v-if="form.errors.processed_at" class="text-red-500 text-sm mt-1">
              {{ form.errors.processed_at }}
            </div>
          </div>
        </div>

        <div class="sm:col-span-3">
          <label class="block text-sm font-medium text-gray-900 dark:text-white">Payment Due Date</label>
          <div class="mt-2">
            <input
              type="date"
              ...
              class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
            />
            <div v-if="form.errors.payment_due_date" class="text-red-500 text-sm mt-1">
        ...
        <div class="sm:col-span-3">
          <label class="block text-sm font-medium text-gray-900 dark:text-white">Payment Received At</label>
          <div class="mt-2">
            <input
              type="date"
              v-model="form.payment_received_at"
              class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
            />
            <div v-if="form.errors.payment_received_at" class="text-red-500 text-sm mt-1">
              {{ form.errors.payment_received_at }}
            </div>
          </div>
        </div>

        <div class="sm:col-span-3">
          <label class="block text-sm font-medium text-gray-900 dark:text-white">Payment Method</label>
          <div class="mt-2">
            <select
        ...
        <div class="sm:col-span-3">
          <label class="block text-sm font-medium text-gray-900 dark:text-white">Receipt Number</label>
          <div class="mt-2">
            <input
              type="text"
              ...
              class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
            />
            <div v-if="form.errors.receipt_number" class="text-red-500 text-sm mt-1">
        ...
        <div class="sm:col-span-3">
          <label class="block text-sm font-medium text-gray-900 dark:text-white">Denial Reason</label>
          <div class="mt-2">
            <textarea
              ...
              class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
            ></textarea>
            <div v-if="form.errors.denial_reason" class="text-red-500 text-sm mt-1">
              {{ form.errors.denial_reason }}
            </div>
          </div>
        </div>

        <div class="sm:col-span-3">
          <label class="block text-sm font-medium text-gray-900 dark:text-white">Translated Notes</label>
          <div class="mt-2">
            <textarea
              v-model="form.translated_notes"
              rows="3"
              class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
            ></textarea>
            <div v-if="form.errors.translated_notes" class="text-red-500 text-sm mt-1">
              {{ form.errors.translated_notes }}
            </div>
          </div>
        </div>
        ...
        <div class="sm:col-span-3 flex items-center">
          <input
            ...
            v-model="form.reimbursement_required"
            class="h-4 w-4 text-cyan-600 focus:ring-cyan-500 border-gray-300 rounded"
          />
          <label for="reimbursement_required" class="ml-2 block text-sm text-gray-900 dark:text-white">Reimbursement Required</label>
          <div v-if="form.errors.reimbursement_required" class="text-red-500 text-sm mt-1">
            {{ form.errors.reimbursement_required }}
          </div>
        </div>
        ...
        <div class="sm:col-span-3 flex items-center">
          <input
            type="checkbox"
            id="is_pre_authorized"
            v-model="form.is_pre_authorized"
            class="h-4 w-4 text-cyan-600 focus:ring-cyan-500 border-gray-300 rounded"
          />
          <label for="is_pre_authorized" class="ml-2 block text-sm text-gray-900 dark:text-white">Is Pre-Authorized</label>
          <div v-if="form.errors.is_pre_authorized" class="text-red-500 text-sm mt-1">
            {{ form.errors.is_pre_authorized }}
          </div>
        </div>
      </div>
    </div>
