    ...
    <div class="flex-1 space-y-4 p-8 pt-6">
      ...
      <div v-if="currentTab === 'Overview'">
        ...
        <div class="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
          <div title="All-time count of registered patients">
            <StatCard
          ...
          <div title="Patients created within the selected date range">
            <StatCard
          ...
          <div title="Total visits scheduled within the selected range">
            <StatCard
          ...
          <div title="Sum of paid invoice amounts within the range">
            <StatCard
              title="Total Revenue"
          ...
          <div title="Unpaid invoice amounts within the range">
            <StatCard
          ...
          <div title="Insurance claims awaiting payment within the range">
            <StatCard
          ...
          <div title="All-time active staff on the platform">
            <StatCard
              title="Active Staff"
