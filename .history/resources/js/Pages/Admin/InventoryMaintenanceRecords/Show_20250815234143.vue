    ...
    <div class="bg-white border border-4 rounded-lg shadow relative m-10">
        ...
        <div class="p-6 border-t border-gray-200 rounded-b">
            <div class="flex flex-wrap gap-2">
              <Link :href="route('admin.inventory-maintenance-records.index')" class="btn btn-outline print:hidden">
                Back to List
              </Link>
              <button @click="printPage" class="btn btn-dark print:hidden">
                <Printer class="h-4 w-4" /> Print Current
              </button>
              <Link :href="route('admin.inventory-maintenance-records.edit', props.maintenanceRecord.id)"
                class="btn btn-primary print:hidden">
                <Edit3 class="w-4 h-4" /> Edit Record
              </Link>
            </div>
        </div>
