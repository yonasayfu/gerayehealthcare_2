      ...
      <div class="rounded-lg border border-border bg-white dark:bg-gray-900 p-4 shadow-sm">
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full text-left text-sm">
            ...
            <tbody>
              <tr v-if="inventoryTransactions && inventoryTransactions.data && inventoryTransactions.data.length > 0" v-for="(transaction, i) in inventoryTransactions.data" :key="transaction.id" class="border-t">
