...
<head>
    <meta charset="UTF-8">
    <title>Assignment Export - Geraye</title>
    <style>
        body {
        ...
        <tbody>
            @foreach ($assignments as $index => $assignment)
                <tr>
                    ...
                    <td>{{ $assignment->shift_start ? \Carbon\Carbon::parse($assignment->shift_start)->format('Y-m-d H:i') : 'N/A' }}</td>
                    <td>{{ $assignment->shift_end ? \Carbon\Carbon::parse($assignment->shift_end)->format('Y-m-d H:i') : 'N/A' }}</td>
